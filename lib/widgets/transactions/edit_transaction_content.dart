...
class EditTransactionContent extends StatefulWidget {
  final String label;
  final String title;
  ...
  @override
  State<EditTransactionContent> createState() => _EditSpendingContentState();
}

class _EditSpendingContentState extends State<EditTransactionContent> {
