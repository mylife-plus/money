                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      Expanded(
                                        child: buildTextField('Amount', '0'),
                                      ),
                                      4.horizontalSpace,
                                      Expanded(
                                        child: SelectInvestmentField(
                                          suggestions: _investmentController
                                              .recommendations,
                                          controller:
                                              _soldInvestmentTextController,
                                          hintText: 'select',
                                          onAdd: _addNewItem,
                                          onSelected: (value) {
                                            _selectSoldRecommendation(
                                              value.text,
                                            );
                                          },
                                        ),
                                      ...
                                      Expanded(
                                        child: SelectInvestmentField(
                                          suggestions: _investmentController
                                              .recommendations,
                                          controller:
                                              _boughtInvestmentTextController,
                                          hintText: 'select',
                                          onAdd: _addNewItem,
                                          onSelected: (value) {
                                            _selectBoughtRecommendation(
                                              value.text,
                                            );
                                          },
                                        ),
