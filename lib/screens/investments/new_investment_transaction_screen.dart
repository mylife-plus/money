...
class NewInvestmentTransactionScreen extends StatefulWidget {
  const NewInvestmentTransactionScreen({super.key});

  @override
  State<NewInvestmentTransactionScreen> createState() =>
      _NewInvestmentTransactionScreenState();
}

class _NewInvestmentTransactionScreenState
    extends State<NewInvestmentTransactionScreen> {
    ...
    return Container(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixStyle: TextStyle(color: Color(0xffB4B4B4), fontSize: 16.sp),
        ),
